...
@configclass
class RslRlPpoActorMultiCriticCfg:
    """Configuration for the PPO actor-critic networks."""

    class_name: str = "ActorMultiCritic"
    """The policy class name. Default is ActorMultiCritic."""

    num_critics: int = MISSING
...
class RslRlMultiCriticPpoAlgorithmCfg:
    ...
    advantage_weights: list[float] = MISSING
    """The weights for the advantages of each critic."""
